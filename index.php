...
<body>
  ...
  <div class="container-fluid">
    ...
    <section id="main" class="coloured-section">
      <div class="row intro py-1" style="background-color: #2785C4;">
        <div class="col-sm-5 col-md">
          <div class="heading text-center my-5" style="color: #050505fb ;">

            <h1>
              <img src="img/bank.jfif" width="100px" height="100px">
    ...
    <div class="row activity text-center">
      <div class="col-md act">
        <img src="img/user.jfif" class="img-fluid">
        <br>
  ...
  <footer class="text-center mt-5 py-2">
    <footer id="footer" class="coloured-section">
      ...
      <p>&copy FEB 2021. Made by <b>DEVISHREE SATPUTE</b>
